...
public class SportsSpectacularWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SportsSpectacularWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SportsSpectacularWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SportsSpectacularWLAIW/InitOutcome.xml").getDocumentElement();
